...
public class GlobalVarDeclars implements SyntaxNode {
    ...
    public GlobalVarDeclars (Type Type, GlobalVarDeclList GlobalVarDeclList) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalVarDeclars(\n");
