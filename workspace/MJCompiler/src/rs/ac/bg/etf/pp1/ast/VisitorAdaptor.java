...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(ObjectAccess ObjectAccess) { visit(); }
    public void visit(NoObjOrCollectionList NoObjOrCollectionList) { visit(); }
    public void visit(ObjOrCollList ObjOrCollList) { visit(); }
    ...
    public void visit(Parens Parens) { visit(); }
    ...
    public void visit(ChConst ChConst) { visit(); }
    ...
    public void visit(RelopExpression RelopExpression) { visit(); }
    ...
    public void visit(MethodDeclarList MethodDeclarList) { visit(); }
    public void visit(Type Type) { visit(); }
    public void visit(NoMultiVarDeclars NoMultiVarDeclars) { visit(); }
    public void visit(MultiVarDeclarations MultiVarDeclarations) { visit(); }
    public void visit(NoMethodDeclars NoMethodDeclars) { visit(); }
    ...
    public void visit(ClassDeclars ClassDeclars) { visit(); }
    public void visit(NoVarDeclList NoVarDeclList) { visit(); }
    public void visit(VarDList VarDList) { visit(); }
    public void visit(NoArray NoArray) { visit(); }
    public void visit(Array Array) { visit(); }
    public void visit(VarDeclars VarDeclars) { visit(); }
    public void visit(ErrGlobalSemi ErrGlobalSemi) { visit(); }
    public void visit(SingleGlobalVarDecl SingleGlobalVarDecl) { visit(); }
    public void visit(ErrGlobalComma ErrGlobalComma) { visit(); }
    public void visit(GlobalVDeclars GlobalVDeclars) { visit(); }
    public void visit(GlobalVarDeclars GlobalVarDeclars) { visit(); }
    ...
    public void visit(ConstDeclars ConstDeclars) { visit(); }
    public void visit(ClassDeclaration ClassDeclaration) { visit(); }
    public void visit(GlobalVarDeclarations GlobalVarDeclarations) { visit(); }
    ...
    public void visit(ConstVarClassDeclares ConstVarClassDeclares) { visit(); }
